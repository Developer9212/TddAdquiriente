...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory",transactionManagerRef = "transactionManager",basePackages = "com.fenoreste_alestra.dao")
public class SpringConfiguration {	
	...
	public LocalContainerEntityManagerFactoryBean entity(){
		...
		em.setPackagesToScan("com.fenoreste_alestra.entity");		
